...
export const plantData = [
  ...
  {
    name: "Imaginary Fern",
    description: "The Imaginary Fern, celestial marvel, boasts otherworldly charm with delicate fronds resembling celestial constellations. Place it in bright indirect light to unveil its mystical allure. Embrace the celestial beauty of this imaginative fern, a unique addition to your indoor sanctuary.",
    wateringDays: 1,
    fertilizingDays: 3,
    temperature: "20-25°C",
    humidity: "50-60%",
